...
public class RelatorioFuncionarioDinamico {
	...
	public void inicial(Scanner scanner) {
		...
		LocalDate dataContatacao;
		if(data.equalsIgnoreCase("NULL")) {
			dataContatacao = null;
		} else {
			dataContatacao = LocalDate.parse(data, formatter);
		}
		...
		List<Funcionario> funcionarios = funcionarioRepository.findAll(Specification
				.where(
						...
						.or(SpecificationFuncionario.dataContratacao(dataContatacao))
				);
